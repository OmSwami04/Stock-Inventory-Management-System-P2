...
import { LayoutDashboard, Box, ArrowLeftRight, Bell, LogOut, Package, Truck, Warehouse, History, FileText } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const navItems = [
    ...
    { name: 'Reports', path: '/reports', icon: <FileText size={20} />, roles: ['Admin', 'InventoryManager'] },
